...
func setup(reminder_scheduler: ReminderScheduler) -> void:
	...
	add_button.theme_type_variation = "ButtonPrimary"
	...
	pending_title.add_theme_color_override("font_color", RockyTheme.MUTED)
...
func _refresh_pending() -> void:
	...
	if scheduler.reminders.is_empty():
		...
		empty.add_theme_color_override("font_color", RockyTheme.MUTED)
